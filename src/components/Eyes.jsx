...
const Eyes = () => {
    ...
    return (
        <div className='eyes w-full h-screen overflow-hidden bg-zinc-300'>
            ...
            >
                <div className='absolute flex top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] gap-12 justify-center items-center'>
